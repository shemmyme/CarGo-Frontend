      ...
      <div style={{ opacity: 1 }}>
        <div className="section-container ">
          <div className="md:block hidden">
            <h2 className="py-2  pl-3 text-base font-semibold leading-7 text-gray-900">My Profile</h2>
            <hr />
          ...
          <div className="md:flex w-full shadow-2xl rounded-lg border border-gray-200 p-4 ">
            <div className="w-full md:w-1/2 md:m-4 pr-4 mt-3 md:mt-0">
                <img src="https://cdn.britannica.com/35/238335-050-2CB2EB8A/Lionel-Messi-Argentina-Netherlands-World-Cup-Qatar-2022.jpg" className="rounded-lg" alt="" />
            </div>
            <div className="w-full md:w-1/2 md:m-4 mt-3 pr-4 md:mt-0">
                <img src="https://cdn.britannica.com/35/238335-050-2CB2EB8A/Lionel-Messi-Argentina-Netherlands-World-Cup-Qatar-2022.jpg" className="rounded-lg" alt="" />
            </div>
          </div>
        </div>
