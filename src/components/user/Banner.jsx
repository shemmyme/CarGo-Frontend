...
const Banner = () => {
  ...
  return (
    <div
      className="h-[550px] md:flex brightness-75 "
      style={{
    ...
    >
      <div className="w-full md:flex space-x-36 ">
        <div className="text-white brightness-100  font-sans text-3xl  text-center w-full md:w-2/3 h-full ">
          <p className="pt-28 brightness-100 font-bold text-4xl text-[50px] text-white  leading-">
            Rent a car from best car rental -<br /> CarGo
          </p>
          <p className="text-xl brightness-100 font-medium pt-5 ">
            CarGo is one of the most trusted car rental services. The rent-a-car
            service provider offers an outstanding model and a wide variety of
            vehicle options at the most competitive rates. At CarGo, we allow
            you to enjoy flexibility with respect to start and endpoints. You
            can book cars on a daily, weekly, monthly basis. Moreover, we
            provide door-step delivery, believe in complete transparency, and
            adhere strictly to business ethics.
          </p>
        </div>
        <div>
            ...
            <h1 className="text-white bg-yellow-500 h-12 w-64 text-center pt-3  rounded-lg">Find the right car now</h1>
              ...
              <div className="flex border border-solid border-l-0 border-b-0  ">
                <div className="flex  ">
                  ...
                  <div>
                    <p>Set your mind free with us</p>
                  </div>
                </div>
                <div className="flex">
                  {/* <div><img src="" alt="img2" /></div> */}

                  <div>Choose your day Package</div>
                </div>
              </div>
            </div>
          </div>
