...
const Faq = () => {
  const dummyFaqs = [
    ...
    },
    {
      ...
      answer: "You'll typically need a valid driver's license and a payment method (credit card or debit card) to rent a car.",
    },
    {
      question: "Is insurance included with the rental?",
      answer: "Basic insurance coverage is often included in the rental cost, but you can choose to upgrade your insurance options during the booking process for added peace of mind.",
    },
    {
      question: "What happens if the car breaks down during my rental?",
      answer: "In the unlikely event of a breakdown, contact our 24/7 customer support. We'll provide assistance, and if necessary, arrange for a replacement vehicle to minimize disruptions to your journey.",
    },
  ];
