                  ...
                  <tr >
                    ...
                    <td className="  text-sm text-gray-800 dark:text-gray-400">
                      <img
                        ...
                        src="https://zedextata.co.in/wp-content/uploads/2023/01/top-offers-from-tata-motar.jpg"
                        alt=""
                      />
                    </td>
                    <td class="p-3 md:w-96  text-sm text-gray-800 dark:text-gray-400 sm:block sm:h-auto sm:w-full sm:p-1">
                      A car, or an automobile, is a motor vehicle with wheels.
                      Most definitions of cars say that they run primarily on
                      roads, seat one to eight people, have four wheels, and
                      mainly transport people, not cargo.
                    </td>
