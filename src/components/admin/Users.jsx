                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800">
                  ...
                  <tr>
                    ...
                    <td className="  text-sm text-gray-800 dark:text-gray-400">
                      <img className="w-40 h-32" src="https://media.istockphoto.com/id/612650934/vector/id-card-isolated-on-white-background-business-identification-icon.jpg?s=612x612&w=0&k=20&c=byimQb2_LJydS803qrpYKk-80dIC4HEp-BidObosij0=" alt="" />
                    </td>
